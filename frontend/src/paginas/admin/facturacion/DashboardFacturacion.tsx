 ...
 * VERSIÓN CORREGIDA: Sin LayoutAdmin wrapper duplicado
 */
...
import { formatearMoneda, formatearNumero, formatearFecha } from '../../../utils/formateo';
...
export const DashboardFacturacion: React.FC = () => {
  ...
  // ✅ CORREGIDO: Sin LayoutAdmin wrapper - solo contenido interno
  return (
